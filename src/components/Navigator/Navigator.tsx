...
import { MdConstruction, MdChevronRight, MdChevronLeft, MdPublic, MdCastle, MdImage } from 'react-icons/md'
    ...
    return (
        <div>
            <div class={style}>
                ...
                <button class={"navigator-button"} onClick={() => location.route('/ft/background')}><MdImage/></button>
